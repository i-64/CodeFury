		...
		<nav class="navbar navbar-inverse navbar-fixed-top">
			...
			<div class="container-fluid">
				...
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="AdminHomePage.jsp"> <img src="images/logo/hsbc-logo-dark_navbar.png"
	...
	<div class=container>
				...
				<form action="AdminCreateRoom" method="post" name="AdminCreateRoomForm" id="AdminCreateRoomForm">
					...
					<div class="row">
						...
						<div class="input-group">
							...
							<input type=text placeholder="Meeting Name" id="meeting_name" name="meeting_name"
								class=form-control onkeyup="validateMeetingName()" required>
					...
					<div class="row">
						...
						<div class="input-group">
							...
							<input type=text placeholder="Seating Capacity" id="seating_capacity"
								name="seating_capacity" class=form-control onkeyup="validateSeatingCapacity()" required>
				...
				%>
					...
					<div class="form-group">
						...
						<select class="form-control" id='meetingType' name='meetingType' required
							...
							<option value="" disabled selected> -----Select Meeting
								Type----- </option>
				  	...
				  	%>
							<option data-q="<%=a.getAmenitites()%>" value="<%=a.getID()%>"><%=a.getType()%></option>
							<%
				  			}
				  		}
				  	%>
					...
					<div class="row text-center">
						...
						<div class="col-sm-12">
							<h4><span class="input-group-addon"><i class="glyphicon glyphicon-tasks"> Select Amenities
									</i></span></h4>
						</div>
					...
					<div class="row text-left">
						...
						<%}%>
								...
								<div class = "col-sm-4">
                    				<label  class="checkbox-inline"> <input title="CREDITS: <%=a.getCredits()%>" type="checkbox"
						id="amenitites" name="amenitites" value="<%=a.getID()%>"><%=a.getAmenity()%></label>
					</div>
		...
		<div class="row">
			...
			<div class="col-sm-4 text-right">
				...
				<button type="button" class="btn  btn-info" name="validateButton" id="validateButton"
					onclick="preFinalValidation()">Confirm Room</button>

			</div>

			<div class="col-sm-4 text-right">

				<button type="submit" class="btn  btn-success" name="submitButton" id="submitButton"
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-sm-3">
					...
					<h2 class="logo"> <a href="AdminHomePage.jsp"> <img src="images/logo/hsbc-logo-dark_2.png"
